...
namespace StrongGrid.UnitTests.Resources
{
	public class SenderAuthenticationTests
	{
		...
		public SenderAuthenticationTests(ITestOutputHelper outputHelper)
		{
		...
		public void Parse_AuthenticatedDomain_json()
		{
			...
			// Act
			var result = JsonSerializer.Deserialize<AuthenticatedDomain>(SINGLE_DOMAIN_JSON, JsonFormatter.DeserializerOptions);
		...
		public async Task GetAllDomainsAsync_include_subusers()
		{
			...
			// Act
			var result = await senderAuthentication.GetAllDomainsAsync(excludeSubusers: false, cancellationToken: TestContext.Current.CancellationToken);
		...
		public async Task GetAllDomainsAsync_exclude_subusers()
		{
			...
			// Act
			var result = await senderAuthentication.GetAllDomainsAsync(excludeSubusers: true, cancellationToken: TestContext.Current.CancellationToken);
		...
		public async Task GetDomainAsync()
		{
			...
			// Act
			var result = await senderAuthentication.GetDomainAsync(domainId, cancellationToken: TestContext.Current.CancellationToken);
		...
		public async Task CreateDomainAsync()
		{
			...
			// Act
			var result = await senderAuthentication.CreateDomainAsync(domain, subdomain, username, ips, automaticSecurity, customSpf, isDefault, customDkimSelector, null, TestContext.Current.CancellationToken);
		...
		public async Task UpdateDomainAsync()
		{
			...
			// Act
			var result = await senderAuthentication.UpdateDomainAsync(domainId, isDefault, customSpf, null, TestContext.Current.CancellationToken);
		...
		public async Task DeleteDomainAsync()
		{
			...
			// Act
			await senderAuthentication.DeleteDomainAsync(domainId, null, TestContext.Current.CancellationToken);
		...
		public async Task AddIpAddressToDomainAsync()
		{
			...
			// Act
			var result = await senderAuthentication.AddIpAddressToDomainAsync(domainId, ipAddress, null, TestContext.Current.CancellationToken);
		...
		public async Task DeleteIpAddressFromDomainAsync()
		{
			...
			// Act
			var result = await senderAuthentication.DeleteIpAddressFromDomainAsync(domainId, ipAddress, null, TestContext.Current.CancellationToken);
		...
		public async Task ValidateDomainAsync()
		{
			...
			// Act
			var result = await senderAuthentication.ValidateDomainAsync(domainId, cancellationToken: TestContext.Current.CancellationToken);
		...
		public async Task GetAssociatedDomainAsync()
		{
			...
			// Act
			var result = await senderAuthentication.GetAssociatedDomainAsync(username, null, TestContext.Current.CancellationToken);
		...
		public async Task DisassociateDomainAsync()
		{
			...
			// Act
			await senderAuthentication.DisassociateDomainAsync(username, null, TestContext.Current.CancellationToken);
		...
		public async Task AssociateDomainAsync()
		{
			...
			// Act
			var result = await senderAuthentication.AssociateDomainAsync(domainId, ipAddress, null, TestContext.Current.CancellationToken);
		...
		public async Task GetAllReverseDnsAsync()
		{
			...
			// Act
			var result = await senderAuthentication.GetAllReverseDnsAsync(cancellationToken: TestContext.Current.CancellationToken);
		...
		public async Task GetReverseDnsAsync()
		{
			...
			// Act
			var result = await senderAuthentication.GetReverseDnsAsync(id, cancellationToken: TestContext.Current.CancellationToken);
		...
		public async Task SetupReverseDnsAsync()
		{
			...
			// Act
			var result = await senderAuthentication.SetupReverseDnsAsync(ipAddress, domain, subdomain, null, TestContext.Current.CancellationToken);
		...
		public async Task DeleteReverseDnsAsync()
		{
			...
			// Act
			await senderAuthentication.DeleteReverseDnsAsync(domainId, null, TestContext.Current.CancellationToken);
		...
		public async Task ValidateReverseDnsAsync()
		{
			...
			// Act
			var result = await senderAuthentication.ValidateReverseDnsAsync(id, null, TestContext.Current.CancellationToken);
		...
		public async Task GetLinkAsync()
		{
			...
			// Act
			var result = await senderAuthentication.GetLinkAsync(linkId, cancellationToken: TestContext.Current.CancellationToken);
		...
		public async Task CreateLinkAsync()
		{
			...
			// Act
			var result = await senderAuthentication.CreateLinkAsync(domain, subdomain, isDefault, null, TestContext.Current.CancellationToken);
		...
		public async Task UpdateLinkAsync()
		{
			...
			// Act
			var result = await senderAuthentication.UpdateLinkAsync(linkId, isDefault, cancellationToken: TestContext.Current.CancellationToken);
		...
		public async Task DeleteLinkAsync()
		{
			...
			// Act
			await senderAuthentication.DeleteLinkAsync(linkId, null, TestContext.Current.CancellationToken);
		...
		public async Task GetDefaultLinkAsync()
		{
			...
			// Act
			var result = await senderAuthentication.GetDefaultLinkAsync(domain, cancellationToken: TestContext.Current.CancellationToken);
		...
		public async Task ValidateLinkAsync()
		{
			...
			// Act
			var result = await senderAuthentication.ValidateLinkAsync(linkId, cancellationToken: TestContext.Current.CancellationToken);
		...
		public async Task GetAssociatedLinkAsync()
		{
			...
			// Act
			var result = await senderAuthentication.GetAssociatedLinkAsync(username, null, TestContext.Current.CancellationToken);
		...
		public async Task DisassociateLinkAsync()
		{
			...
			// Act
			await senderAuthentication.DisassociateLinkAsync(username, null, TestContext.Current.CancellationToken);
		...
		public async Task AssociateLinkAsync()
		{
			...
			// Act
			var result = await senderAuthentication.AssociateLinkAsync(linkId, username, null, TestContext.Current.CancellationToken);
		...
		public async Task GetAllLinksAsync()
		{
			...
			// Act
			var result = await senderAuthentication.GetAllLinksAsync(cancellationToken: TestContext.Current.CancellationToken);
