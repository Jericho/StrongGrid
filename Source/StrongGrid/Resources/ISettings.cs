...
namespace StrongGrid.Resources
{
	...
	public interface ISettings
	{
		...
		/// The <see cref="BouncePurgeSettings" />.
		/// </returns>
		Task<BouncePurgeSettings> UpdateBouncePurgeMailSettingsAsync(bool enabled, int hardBounces, int softBounces, string onBehalfOf = null, CancellationToken cancellationToken = default);
