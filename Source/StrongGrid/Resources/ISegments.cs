...
namespace StrongGrid.Resources
{
	...
	public interface ISegments
	{
		...
		/// <param name="queryLanguageVersion">The version of the query language.</param>
		/// <param name="cancellationToken">The cancellation token.</param>
		/// <returns>
		/// The <see cref="Segment" />.
		/// </returns>
		Task<Segment> CreateAsync(string name, string query, string listId = null, QueryLanguageVersion queryLanguageVersion = QueryLanguageVersion.Version1, CancellationToken cancellationToken = default);
		...
		/// The <see cref="Segment" />.
		/// </returns>
		Task<Segment> UpdateAsync(string segmentId, Parameter<string> name = default, Parameter<string> query = default, Parameter<QueryLanguageVersion> queryLanguageVersion = default, CancellationToken cancellationToken = default);
