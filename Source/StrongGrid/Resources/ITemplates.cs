...
namespace StrongGrid.Resources
{
	...
	public interface ITemplates
	{
		...
		/// </returns>
		Task<Template> CreateAsync(string name, string onBehalfOf = null, CancellationToken cancellationToken = default(CancellationToken));
		...
		/// </returns>
		Task<Template[]> GetAllAsync(string onBehalfOf = null, CancellationToken cancellationToken = default(CancellationToken));
		...
		/// </returns>
		Task<TemplateVersion> CreateVersionAsync(string templateId, string name, string subject, string htmlContent, string textContent, bool isActive, string onBehalfOf = null, CancellationToken cancellationToken = default(CancellationToken));
		...
		/// The <see cref="TemplateVersion" />.
		/// </returns>
		Task<TemplateVersion> UpdateVersionAsync(string templateId, string versionId, string name = null, string subject = null, string htmlContent = null, string textContent = null, bool? isActive = null, string onBehalfOf = null, CancellationToken cancellationToken = default(CancellationToken));
