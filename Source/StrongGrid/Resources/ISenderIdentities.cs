...
namespace StrongGrid.Resources
{
	...
	public interface ISenderIdentities
	{
		...
		/// The async task.
		/// </returns>
		Task DeleteAsync(long senderIdentityId, CancellationToken cancellationToken = default);
		...
		/// The async task.
		/// </returns>
		Task ResendVerificationAsync(long senderIdentityId, CancellationToken cancellationToken = default);
